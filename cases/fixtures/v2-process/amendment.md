...
- 2026-09-20 Q: How is R1 measured? → A: by the index visit count.
- 2026-09-25 Q: The view timing is noise-sized; how is A1 gated? → A: A1 gates `unUse` alone and never subtracts the view timing.
  ...
  "inventories": [
    {
      ...
      "entry_points": [
        { "name": "view rebuild", "exempt": "A1 gate subtracts the view timing before comparing" }
      ]
    }
  ],
  "writes": [
