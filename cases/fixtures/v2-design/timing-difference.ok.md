...
- A2 Timing `use` end to end for 500 and 4000 sequential plugins, the mean time per call grows by at most 2x; the mean time of `metrics()` is recorded without a threshold.
