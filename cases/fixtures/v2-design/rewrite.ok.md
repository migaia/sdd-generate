...
## Steps
- S1 Rewrite `packages/feature-a/index.ts` so `featureA()` builds the index in one batch.
  ...
  "inventories": [
    {
      "id": "I1",
      "requirement": "R1",
      "kind": "current-behaviour",
      "statement": "Observable behaviour of the replaced index code",
      "entry_points": [
        { "name": "featureA ordering", "path": "packages/feature-a/index.ts:1", "acceptance": ["A1"] }
      ]
    }
  ],
  "writes": [
