  ...
  "inventories": [
    {
      ...
      "requirement": "R1",
      "kind": "cost-path",
      "statement": "Whole-collection work on the removal path.",
      "entry_points": [
        { "name": "commitRemoval", "path": "packages/feature-a/index.ts", "acceptance": ["A1"] },
        { "name": "`createView` read-only view", "exempt": "O(N) by design: a view lists every member" },
        { "name": "commitRemoval returns createView", "exempt": "A1 times commitRemoval with the view excluded; the view is O(N) by design" }
      ]
    }
  ],
  "writes": [
